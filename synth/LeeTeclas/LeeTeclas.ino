...
uint8_t periodo = 100; //Cada cuanto se toma una muestra
uint8_t ADOS = 0; //Variable A2 del multiplexor A[3:0]
uint8_t AUNO = 0; //Variable A1 del multiplexor A[3:0]
uint8_t ACERO = 0; //Variable A0 del multiplexor A[3:0]
